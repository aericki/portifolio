...
const Footer: React.FC<FooterProps> = ({ isDarkMode }) => {
  ...
  return (
    <footer
      className={`pt-4 pb-8 ${isDarkMode ? "bg-gray-900" : "bg-gray-100"}`}
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div
            className={`flex flex-wrap justify-center items-center gap-6 py-8 border-t border-b mb-8 ${
              isDarkMode
        ...
        <div className="text-center">
          <p
            className={`text-sm ${isDarkMode ? "text-gray-600" : "text-gray-500"}`}
          >
            © {currentYear} Aericki Trindade Araujo de Jesus Ferreira.{" "}
            {t("footer.copyright")}
          </p>
          <p
            className={`text-xs mt-2 flex justify-center items-center gap-1 ${isDarkMode ? "text-gray-700" : "text-gray-400"}`}
          >

...
const projects: Project[] = [
  {
    ...
    description: "Uma plataforma web para encontrar locais de treino de breaking, com geolocalização e design responsivo. Permite que usuários cadastrem e avaliem locais para prática de breaking.",
